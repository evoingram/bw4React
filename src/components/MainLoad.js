		...
		if (props.searchResultsH === null) {
			return (
				<div>
					...
					/>
					<TicketListH
						ticketsH={props.searchResultsH}
						searchResultsH={props.searchResultsH}
						setSearchResultsH={props.setSearchResultsH}
					/>
					<SearchFormQ
						ticketsQ={props.ticketsQ}
						searchResultsQ={props.searchResultsQ}
						setSearchResultsQ={props.setSearchResultsQ}
						profile={props.profile}
					/>
				</div>
			);
